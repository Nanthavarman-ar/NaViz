 ...
 */
export function calculateSunAngle(date, latitude = 40.7128, longitude = -74.0060) {
 ...
 */
export function calculateSunIntensity(sunAngle) {
    if (sunAngle < -6)
        return 0.05; // Night
    if (sunAngle < 0)
 ...
 */
export function calculateColorTemperature(sunAngle) {
    if (sunAngle < -6)
 ...
 */
export function calculateRealWorldLighting(date, latitude = 40.7128, longitude = -74.0060) {
