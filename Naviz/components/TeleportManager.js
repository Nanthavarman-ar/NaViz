...
export class TeleportManager {
    constructor(options) {
        ...
        Object.defineProperty(this, "arcHeight", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "teleportArc", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "teleportReticle", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "fadePlane", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        // Materials
        Object.defineProperty(this, "arcMaterial", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "reticleMaterial", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "fadeMaterial", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
     ...
     */
    calculateTeleportTarget(direction, origin) {
     ...
     */
    isValidTeleportLocation(position) {
    ...
    async fadeOut() {
        return new Promise((resolve) => {
            ...
            const animation = BABYLON.Animation.CreateAndStartAnimation("fadeOut", this.fadeMaterial, "alpha", 30, this.fadeDuration / 16.67, // Convert ms to frames
            0, 1, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
    ...
    async fadeIn() {
        return new Promise((resolve) => {
            ...
            const animation = BABYLON.Animation.CreateAndStartAnimation("fadeIn", this.fadeMaterial, "alpha", 30, this.fadeDuration / 16.67, 1, 0, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
