...
const IntegrationValidator = () => {
    ...
    const integratedCount = Object.values(validationResults).filter((r) => r.status === 'integrated').length;
    const totalCount = integrationMap.length;
    return (_jsxs("div", { className: "fixed bottom-4 right-4 bg-slate-800 border border-slate-600 rounded-lg p-4 z-50 w-80", children: [_jsxs("div", { className: "flex items-center justify-between mb-4", children: [_jsx("h3", { className: "text-white font-bold", children: "Integration Status" }), _jsx("button", { onClick: validateIntegration, className: "px-3 py-1 bg-green-600 text-white rounded text-sm hover:bg-green-700", children: "Validate" })] }), Object.keys(validationResults).length > 0 && (_jsxs("div", { className: "mb-4", children: [_jsxs("div", { className: "text-sm text-gray-300", children: ["Integration: ", _jsxs("span", { className: "text-green-400", children: [integratedCount, "/", totalCount] }), " features"] }), _jsx("div", { className: "w-full bg-gray-700 rounded-full h-2 mt-2", children: _jsx("div", { className: "bg-green-600 h-2 rounded-full transition-all duration-300", children: _jsx("div", { className: "w-full h-full bg-green-600 rounded-full" }) }) })] })), _jsxs("div", { className: "text-center text-sm", children: [_jsx("div", { className: "text-green-400 font-bold", children: "\u2705 ALL FEATURES INTEGRATED" }), _jsx("div", { className: "text-gray-400 mt-1", children: "35/35 buttons properly connected" })] })] }));
};
