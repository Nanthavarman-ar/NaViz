import { Vector3, StandardMaterial, TransformNode, ParticleSystem } from '@babylonjs/core';
...
export class SeasonalDecorManager {
    constructor(scene) {
        ...
        Object.defineProperty(this, "activeDecoration", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "autoSwitchEnabled", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        });
        Object.defineProperty(this, "autoSwitchInterval", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "particleSystems", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
     ...
     */
    createDecoration(id, name, season, elements) {
        try {
     ...
     */
    enableAutoSwitch(intervalMinutes) {
        try {
     ...
     */
    createDecorationElement(decorationId, element, index) {
        try {
     ...
     */
    createFlowersMesh(name) {
        const flowerGroup = [];
        for (let i = 0; i < 5; i++) {
            const flower = BABYLON.MeshBuilder.CreateSphere(`${name}_flower_${i}`, { diameter: 0.2 }, this.scene);
            flower.position = new Vector3((Math.random() - 0.5) * 2, Math.random() * 0.5, (Math.random() - 0.5) * 2);
     ...
     * @param index - Element index
     */
    createParticleSystem(name, element, index) {
        try {
            if (!element.particleSystem)
                return;
     ...
     */
    disposeDecorationElements(decorationId) {
        try {
