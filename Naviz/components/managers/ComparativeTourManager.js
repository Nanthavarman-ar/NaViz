...
export class ComparativeTourManager {
    constructor(scene, bimManager) {
        ...
        Object.defineProperty(this, "tours", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        ...
        Object.defineProperty(this, "splitPlane", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "annotationMeshes", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
     ...
     */
    createTour(id, name, description, leftView, rightView) {
        try {
    ...
    resetCamera() {
        try {
            if (this.scene.activeCamera) {
                ...
                if (typeof this.scene.activeCamera.setTarget === 'function') {
                    this.scene.activeCamera.setTarget(Vector3.Zero());
                }
                else if (typeof this.scene.activeCamera.lookAt === 'function') {
                    this.scene.activeCamera.lookAt(Vector3.Zero());
                }
            }
        }
        catch (error) {
