...
export class MaterialLifecycleManager {
    ...
    applyAgingEffect(materialName, ageYears, mesh) {
    ...
    applyWoodAging(material, factor) {
    ...
    applyPaintAging(material, factor) {
    ...
    applyMetalAging(material, factor) {
        // Metal develops rust
    ...
    generateWoodTexture(ctx, width, height, age) {
    ...
    generateCrackTexture(ctx, width, height, age) {
    ...
    generateRustTexture(ctx, width, height, age) {
    ...
    previewAging(materialName, ageYears) {
        const material = this.materials.get(materialName);
        if (!material)
            return null;
