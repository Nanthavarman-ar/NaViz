...
export class GestureManager {
    constructor(engine, scene, deviceDetector) {
        ...
        Object.defineProperty(this, "deviceDetector", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "recognitionInterval", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "gestureCallbacks", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "lastGesture", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "gestureHistory", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
    ...
    analyzeImageForGestures(imageData) {
    ...
    removeGestureCallback(callback) {
    ...
    notifyGestureCallbacks(gesture) {
    ...
    simulateGesture(gestureType, confidence = 0.8) {
        const gesture = {
            gesture: gestureType,
            confidence,
            timestamp: Date.now(),
