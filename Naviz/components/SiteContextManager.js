...
export class SiteContextManager {
    constructor(engine, scene, featureManager, geoSyncManager, externalAPIManager, aiManager, simulationManager, bimManager) {
        ...
        Object.defineProperty(this, "geoSyncManager", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "externalAPIManager", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "terrainMesh", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "terrainGroup", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "noiseGroup", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "pollutionGroup", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "buildingsGroup", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "overlayGroup", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "terrainData", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        });
        Object.defineProperty(this, "noiseData", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "pollutionData", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "surroundingBuildings", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "constructionPhotos", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
    ...
    async initializeSiteContext() {
        try {
            ...
            if (this.noiseGroup)
                this.noiseGroup.setEnabled(false);
            if (this.pollutionGroup)
                this.pollutionGroup.setEnabled(false);
            if (this.buildingsGroup)
                this.buildingsGroup.setEnabled(false);
            if (this.overlayGroup)
                this.overlayGroup.setEnabled(false);
    ...
    async generateTerrain(centerLocation, radius = 1000) {
    ...
    // Get elevation data from external APIs
    async getElevationData(center, radius) {
        ...
        for (let x = 0; x < gridSize; x++) {
            ...
            for (let z = 0; z < gridSize; z++) {
                ...
                const distanceFromCenter = Math.sqrt(Math.pow(x - gridSize / 2, 2) + Math.pow(z - gridSize / 2, 2));
    ...
    applyElevationToTerrain(mesh, elevationData, centerLocation) {
    ...
    async startPollutionSimulation() {
    ...
    generatePollutionData(location) {
        this.pollutionData = [];
    ...
    async generateSurroundingBuildings(centerLocation, radius = 500) {
        if (!this.config.surroundingBuildingsEnabled)
            return;
        try {
            ...
            if (buildingLayout && buildingLayout.buildings) {
                this.surroundingBuildings = buildingLayout.buildings.map((building) => ({
                    id: building.id,
    ...
    createBuildingMeshes() {
        ...
        this.surroundingBuildings.forEach(building => {
            ...
            const buildingMesh = MeshBuilder.CreateBox(`building_${building.id}`, { size: 1, updatable: false }, this.scene);
    ...
    async addConstructionPhoto(photo) {
        if (!this.config.constructionOverlayEnabled || !this.overlayGroup)
            return;
        try {
