export class FeatureManager {
    constructor(deviceCapabilities) {
        ...
        Object.defineProperty(this, "featureStates", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        });
        Object.defineProperty(this, "deviceCapabilities", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    shouldEnableFeature(feature) {
        ...
        if (feature.requiresCapability) {
            for (const cap of feature.requiresCapability) {
                if (!this.deviceCapabilities[cap]) {
                    return false;
                }
            }
        }
    ...
    setFeatureEnabled(featureId, enabled, reason) {
    ...
    addFeatureListener(featureId, callback) {
    ...
    removeFeatureListener(featureId, callback) {
    ...
    notifyFeatureChange(featureId, enabled) {
        const listeners = this.listeners.get(featureId);
        if (listeners) {
